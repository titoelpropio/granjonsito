            ...
            <div class="panel panel-green">
                <div class="panel-heading">
                      <ul class="nav nav-pills">
                        <li class="active"><a href="{!!URL::to('lista_maple')!!}">LISTA DE MAPLES</a></li>
                        <li class="active"><a href="{!!URL::to('comparar_maples')!!}">COMPARAR MAPLES</a></li>
                    </ul>
                </div>  
            </div>
</div>
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
 <div class="pull-right"> 
    ...
    <div class="col-sm-1 col-md-1  col-sm-1  col-xs-12 pull-right" style="width: 15%; margin: 0px; padding: 0px">
      <div class="form-group"> <button class="btn btn-danger" onclick=" cargar_lista_maple_1()">MOSTRAR</button> </div>
    </div>
      ...
      <div class="form-group">  <B>DESDE: </B> </div>
                ...
                <table class="table table-striped table-bordered table-condensed table-hover">
                    <thead bgcolor=black style="color: white">
                        <th><center>TIPO DE MAPPLE</center></th>
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
 ...
 <div class="pull-right"> 
    ...
    <div class="col-sm-1 col-md-1  col-sm-1  col-xs-12 pull-right" style="width: 15%; margin: 0px; padding: 0px">
      <div class="form-group"> <button class="btn btn-danger" onclick=" cargar_lista_maple_2()">MOSTRAR</button> </div>
    </div>
