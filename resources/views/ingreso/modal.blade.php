...
<div class="modal fade" id="myModalActualizar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
              <div class="modal-header">
                <h3 id="titulogalpon" class="modal-title" >ACTUALIZAR INGRESO</h3>
              </div>
       <?php // {!!Form::open(['route'=>['ingreso.update','null'],'method'=>'PUT'])!!} ?>
            <div class="modal-body">                    
              <input type='hidden' class="form-control" id="id_ingreso_ac" name="id_ingreso_ac"/>
              <div class="form-group">
                  {!!Form::label('id_categoria','Categoria:')!!}
      ...
      {!!Form::close()!!}*/ ?>
      <button class="btn btn-primary" onclick="actualizar_ingreso()">ACTUALIZAR</button>
...
<div class="modal fade" id="myModalAnular" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        {!!Form::open(['route'=>['ingreso.destroy','null'],'method'=>'DELETE'])!!}
            <div class="modal-body">
                    <CENTER><H2>DESEA ANULAR ESTE INGRESO</H2></CENTER>
                    <input type='hidden' class="form-control" id="id_ingreso" name="id_ingreso"/>
            </div>
                
            <div class="modal-footer">
               {!!Form::submit('ANULAR INGRESO',['class'=>'btn btn-primary'])!!}
        {!!Form::close()!!}
                {!!link_to('#', $title='CANCELAR', $attributes = ['id'=>'cancelar','data-dismiss'=>'modal', 'class'=>'btn btn-danger'], $secure = null)!!}
            </div>
            </div>
